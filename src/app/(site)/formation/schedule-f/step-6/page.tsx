...
export default function FormationScheduleFStep6Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-f/step-6";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule F step 6 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-f/step-7");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-f/step-5"
              isLoading={isLoading}
            />
          </form>
        </Form>
