...
export default function FormationScheduleAStep14Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-a/step-14";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule A step 14 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-a/step-15");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-a/step-13"
              isLoading={isLoading}
            />
          </form>
        </Form>
