...
export default function FormationScheduleAStep11Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-a/step-11";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule A step 11 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-a/step-12");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-a/step-10"
              isLoading={isLoading}
            />
          </form>
        </Form>
