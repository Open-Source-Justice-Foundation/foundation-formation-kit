...
export default function FormationScheduleAStep10Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-a/step-10";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule A step 10 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-a/step-11");
    } catch (err) {
      // TODO
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormDescription>
                    Do you conduct baptisms, weddings, funerals, or other
                    religious rites?
                  </FormDescription>
                  <FormControl>
                    <RadioGroup
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/schedule-a/step-9" className="text-base">
