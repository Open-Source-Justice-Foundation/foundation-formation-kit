...
export default function FormationScheduleAStep6Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-a/step-6";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule A step 6 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-a/step-7");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
              ...
              render={({ field }) => (
                <FormItem>
                  <FormDescription className="text-sm font-normal sm:text-base">
                    Do you have a form of worship? If &quot;Yes,&quot; describe
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Form of worship description</FormLabel>
                  <FormControl>
                    <Textarea
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/schedule-a/step-5" className="text-base">
