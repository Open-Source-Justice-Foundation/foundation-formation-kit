...
export default function FormationScheduleAStep1Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-a/step-1";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule A step 1 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-a/step-2");
    } catch (err) {
      // TODO
          ...
          >
                ...
                <FormItem>
                  <FormDescription>
                    ...
                    <span className="mt-1.5 block">
                      If &quot;Yes,&quot; describe your written creed, statement
                      of faith, or summary of beliefs.
                    </span>
                  </FormDescription>
                  <FormControl>
                    <RadioGroup
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Written Creed, Statement of Faith, or Summary of Beliefs
                  </FormLabel>
                  <FormControl>
                    <Textarea
