...
export default function FormationScheduleAStep12Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-a/step-12";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule A step 12 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-a/step-13");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-a/step-11"
              isLoading={isLoading}
            />
          </form>
        </Form>
