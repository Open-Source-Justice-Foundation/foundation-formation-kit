...
export default function FormationScheduleAStep5Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-a/step-5";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule A step 5 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-a/step-6");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-a/step-4"
              isLoading={isLoading}
            />
          </form>
        </Form>
