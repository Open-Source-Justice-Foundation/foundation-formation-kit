  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule A step 7 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-a/step-8");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
              ...
              render={({ field }) => (
                <FormItem>
                  <FormDescription className="text-sm font-normal sm:text-base">
                    Do you have regularly scheduled religious services? If
                    &quot;Yes,&quot; describe the nature of the services.
                  </FormDescription>
                  <FormControl>
                    <RadioGroup
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Nature of services description</FormLabel>
                  <FormControl>
                    <Textarea
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/schedule-a/step-6" className="text-base">
