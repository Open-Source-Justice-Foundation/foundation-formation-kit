...
export default function FormationScheduleAStep8Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-a/step-8";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule A step 8 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-a/step-9");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-a/step-7"
              isLoading={isLoading}
            />
          </form>
        </Form>
