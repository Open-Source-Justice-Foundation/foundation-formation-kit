...
export default function FormationScheduleAStep2Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-a/step-2";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule A step 2 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-a/step-3");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-a/step-1"
              isLoading={isLoading}
            />
          </form>
        </Form>
