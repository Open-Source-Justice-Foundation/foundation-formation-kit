...
export default function FormationScheduleBStep5Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-b/step-5";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule B step 5 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-b/step-6");
    } catch (err) {
      // TODO
          ...
          >
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/schedule-b/step-4" className="text-base">
