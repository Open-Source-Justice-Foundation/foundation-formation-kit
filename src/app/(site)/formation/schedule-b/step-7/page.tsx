...
export default function FormationScheduleBStep7Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-b/step-7";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule B step 7 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-b/step-8");
    } catch (err) {
      // TODO
          ...
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    State where the policy is located or if adopted by
                    resolution of your governing body.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/schedule-b/step-6" className="text-base">
