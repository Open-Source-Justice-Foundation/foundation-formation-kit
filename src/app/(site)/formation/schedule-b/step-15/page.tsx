...
export default function FormationScheduleBStep15Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-b/step-15";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule B step 15 response status: ${response?.status}`,
        );
      }
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-b/step-14"
              isLoading={isLoading}
            />
          </form>
        </Form>
