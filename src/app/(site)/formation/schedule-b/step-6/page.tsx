...
export default function FormationScheduleBStep6Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-b/step-6";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule B step 6 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-b/step-7");
    } catch (err) {
      // TODO
          ...
          >
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/schedule-b/step-5" className="text-base">
