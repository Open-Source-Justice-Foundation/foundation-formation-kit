...
export default function FormationPart5Step7Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/part-5/step-7";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation part 5 step 7 response status: ${response?.status}`,
        );
      }

      router.push("/formation/part-5/step-8");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/part-5/step-6"
              isLoading={isLoading}
            />
          </form>
        </Form>
