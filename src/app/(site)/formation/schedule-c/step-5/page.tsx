  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule C step 5 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-c/step-6");
    } catch (err) {
      // TODO
          ...
          >
              ...
              render={({ field }) => (
                <FormItem>
                  <FormDescription className="text-sm font-normal sm:text-base">
                    Do you or will you maintain a full-time emergency room? If
                    &quot;Yes,&quot; continue to Line 6.
                  </FormDescription>
                  <FormControl>
                    <RadioGroup
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/schedule-c/step-4" className="text-base">
