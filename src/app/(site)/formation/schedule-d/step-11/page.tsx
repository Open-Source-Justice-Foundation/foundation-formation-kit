...
export default function FormationScheduleDStep11Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-d/step-11";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule D step 11 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-d/step-12");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-d/step-10"
              isLoading={isLoading}
            />
          </form>
        </Form>
