...
export default function FormationScheduleDStep12Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-d/step-12";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule D step 12 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-d/step-13");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-d/step-11"
              isLoading={isLoading}
            />
          </form>
        </Form>
