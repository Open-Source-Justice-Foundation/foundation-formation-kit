...
export default function FormationScheduleDStep6Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-d/step-6";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule D step 6 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-d/step-7");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-d/step-5"
              isLoading={isLoading}
            />
          </form>
        </Form>
