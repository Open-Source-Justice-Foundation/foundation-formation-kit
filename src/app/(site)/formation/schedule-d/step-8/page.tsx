...
export default function FormationScheduleDStep8Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-d/step-8";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule D step 8 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-d/step-9");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/schedule-d/step-7"
              isLoading={isLoading}
            />
          </form>
        </Form>
