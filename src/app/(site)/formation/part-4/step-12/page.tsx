...
export default function FormationPart4Step12Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/part-4/step-12";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation part 4 step 12 response status: ${response?.status}`,
        );
      }

      router.push("/formation/part-4/step-13");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>School Operation</FormLabel>
                  <FormDescription>
                    Do you or will you operate a school? If &quot;Yes,&quot;
                    complete Schedule B.
                  </FormDescription>
                  <FormControl>
                    <RadioGroup
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/part-4/step-11" className="text-base">
