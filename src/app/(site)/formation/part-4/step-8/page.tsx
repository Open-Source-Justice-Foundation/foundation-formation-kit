...
export default function FormationPart4Step8Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/part-4/step-8";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation part 4 step 8 response status: ${response?.status}`,
        );
      }

      router.push("/formation/part-4/step-9");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/part-4/step-7"
              isLoading={isLoading}
            />
          </form>
        </Form>
