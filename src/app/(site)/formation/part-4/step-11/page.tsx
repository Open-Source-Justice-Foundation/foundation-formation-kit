...
export default function FormationPart4Step11Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/part-4/step-11";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation part 4 step 11 response status: ${response?.status}`,
        );
      }

      router.push("/formation/part-4/step-12");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/part-4/step-10"
              isLoading={isLoading}
            />
          </form>
        </Form>
