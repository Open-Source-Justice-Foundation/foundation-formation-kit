...
export default function FormationPart4Step17Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/part-4/step-17";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation part 4 step 17 response status: ${response?.status}`,
        );
      }

      router.push("/formation/part-5/step-1");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
                ...
                <FormItem>
                  <FormDescription>
                    ...
                    <span className="mt-1.5 block">
                      If &quot;Yes,&quot; describe these arrangements, including
                      the names or descriptions of the organizations for which
                      you raise funds.
                    </span>
                  </FormDescription>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Fundraising Activities Arrangements</FormLabel>
                  <FormControl>
                    <Textarea
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/part-4/step-16" className="text-base">
