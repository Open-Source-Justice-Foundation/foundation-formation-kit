...
export default function FormationPart4Step4Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/part-4/step-4";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation part 4 step 4 response status: ${response?.status}`,
        );
      }

      router.push("/formation/part-4/step-5");
    } catch (err) {
      // TODO
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormationNavigationButtons
              prevHref="/formation/part-4/step-3"
              isLoading={isLoading}
            />
          </form>
        </Form>
