...
export default function FormationScheduleGStep5Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-g/step-5";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule G step 5 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-g/step-6");
    } catch (err) {
      // TODO
          ...
          >
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/schedule-g/step-4" className="text-base">
