...
export default function FormationScheduleGStep6Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-g/step-6";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule G step 6 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-g/step-7");
    } catch (err) {
      // TODO
          ...
          >
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/schedule-g/step-5" className="text-base">
