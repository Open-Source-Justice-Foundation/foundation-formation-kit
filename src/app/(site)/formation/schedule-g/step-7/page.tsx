...
export default function FormationScheduleGStep7Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-g/step-7";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule G step 7 response status: ${response?.status}`,
        );
      }
          ...
          >
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/schedule-g/step-6" className="text-base">
