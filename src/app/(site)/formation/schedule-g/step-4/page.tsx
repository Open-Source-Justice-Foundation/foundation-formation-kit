...
export default function FormationScheduleGStep4Page() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/formation/schedule-g/step-4";
    ...
    try {
      ...
      if (response?.status !== 200) {
        throw new Error(
          `Formation schedule G step 4 response status: ${response?.status}`,
        );
      }

      router.push("/formation/schedule-g/step-5");
    } catch (err) {
      // TODO
          ...
          >
            ...
            <div className="flex justify-between">
              <Button
                ...
                disabled={isLoading}
              >
                <Link href="/formation/schedule-g/step-3" className="text-base">
