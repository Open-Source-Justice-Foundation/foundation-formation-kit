...
export default function UpdateEmailAddressPage() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const url = "/api/auth/update-email-address";
    let updateEmailAddressResponse: Response = new Response();

    try {
      if (token !== null) {
        updateEmailAddressResponse = await fetch(url, {
          method: "POST",
          headers: {
        ...
        router.push("/updated-email-address");
      } else {
    ...
    <Card className="flex w-[360px] flex-col sm:w-[425px]">
      <CardHeader className="px-4 pt-4 sm:px-6 sm:pt-6">
        ...
        <CardDescription>
          ...
          <br />
          Enter your password to update your email address.
        </CardDescription>
      </CardHeader>
