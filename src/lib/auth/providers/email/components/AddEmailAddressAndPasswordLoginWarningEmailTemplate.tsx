...
export function AddEmailAddressAndPasswordLoginWarningEmailTemplate() {
  return (
    <Html lang="en" dir="ltr">
      <Head>
        <title>Add Email Address and Password Login Requested</title>
        <Font
          fontFamily="Inter"
      ...
      <Preview>
        A request has been made to add an email address and password login to
        your account
      </Preview>
        ...
        <Section style={emailStyles.sectionContent}>
          ...
          <Row>
            <Text style={emailStyles.textContent}>
              A request has been made to add an email address and password login
              to your account.
            </Text>
          </Row>
          <Row>
